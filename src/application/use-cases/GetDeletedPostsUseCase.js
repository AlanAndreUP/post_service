class GetDeletedPostsUseCase {
  ...
  async execute(page = 1, limit = 10) {
    ...
    // Obtener posts eliminados paginados
    const posts = await this.postRepository.findDeleted(normalizedPage, normalizedLimit);
    
    // Obtener total de posts eliminados para la paginación
    const total = await this.postRepository.count({ deleted: true });
...
module.exports = GetDeletedPostsUseCase; 